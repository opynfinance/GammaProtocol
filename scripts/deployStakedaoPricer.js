...
const StakedaoPricer = artifacts.require('StakedaoPricer.sol')
...
module.exports = async function(callback) {
  try {
    ...
    console.log(`Deploying Stakedao pricer contract to ${options.network} 🍕`)
    ...
    console.log('Stakedao pricer deployed! 🎉')
