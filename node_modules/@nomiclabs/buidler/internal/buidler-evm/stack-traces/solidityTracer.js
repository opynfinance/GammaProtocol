...
class SolidityTracer {
    constructor(_bytecodes) {
        this._bytecodes = _bytecodes;
        this._files = new Map();
        // TODO: Change this when we get to support multiple compilations in a
        //  single Buidler EVM run.
        for (const bytecode of _bytecodes) {
            this._files.set(bytecode.contract.location.file.globalName, bytecode.contract.location.file);
        }
    }
            ...
            if (trace.bytecode.contract.receive === undefined ||
                ...
                if (trace.bytecode.contract.fallback !== undefined) {
                    ...
                    revertFrame = {
                        ...
                        sourceReference: {
                            contract: trace.bytecode.contract.name,
                            function: solidity_stack_trace_1.FALLBACK_FUNCTION_NAME,
                            fileGlobalName: trace.bytecode.contract.fallback.location.file.globalName,
                ...
                revertFrame = {
                    ...
                    sourceReference: {
                        ...
                        fileGlobalName: trace.bytecode.contract.receive.location.file.globalName,
