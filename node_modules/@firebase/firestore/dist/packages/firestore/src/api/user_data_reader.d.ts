...
export declare class UserDataReader {
    ...
    parseSetData(methodName: string, input: unknown, options?: firestore.SetOptions): ParsedSetData;
    /** Parse update data from an update() call. */
    parseUpdateData(methodName: string, input: unknown): ParsedUpdateData;
    /** Parse update data from a list of field/value arguments. */
    parseUpdateVarargs(methodName: string, field: string | BaseFieldPath, value: unknown, moreFieldsAndValues: unknown[]): ParsedUpdateData;
 ...
 */
export declare function fieldPathFromArgument(methodName: string, path: string | BaseFieldPath): FieldPath;
/**
 ...
 * on dots.
 */
export declare function fieldPathFromDotSeparatedString(methodName: string, path: string): FieldPath;
export {};
