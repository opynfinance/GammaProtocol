...
var U = /^[_a-zA-Z][_a-zA-Z0-9]*$/, P = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.$ = function(t, e, r) {
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Q(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return Se(t.arrayValue.values || [], e.arrayValue.values || [], Q);
...
function Y(t, e) {
    ...
    var n = X(t), r = X(e), i = ke(n.seconds, r.seconds);
...
var st = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Se(this.elements, e.elements, Q);
    }, t;
}(), ut = /** @class */ function() {
    function t(t) {
        this.elements = t;
...
e) {
     ...
     */
    t.It = function(t) {
        return t instanceof _t ? t.version : V.min();
    }, t;
}(), yt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        ...
        return this.Et(t), this.Rt.Tt(t) ? new Dt(this.key, V.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var Nt, At, Tt = function(t, e) {
     ...
     */ , s) {
        void 0 === i && (i = V.min()), void 0 === o && (o = V.min()), void 0 === s && (s = C.ht), 
 ...
 */ var ie = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, ae.fs(e, n)), new t(V.min(), r, re(), Kt(), ee());
    }, t;
}(), ae = /** @class */ function() {
    function t(
    /**
 ...
 */ var ve = {
    ...
    t.prototype.ci = function(t) {
        ...
        // in the local target cache.
                return 4 === e.length ? S.H : this.wi(e);
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.mi = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            d.document;
            var y = this.Z(d.document), v = d.readTime ? this.fromVersion(d.readTime) : V.min(), m = new Dt(y, v), g = d.removedTargetIds || [];
            e = new he([], g, m.key, m);
...
var je = function() {
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.q(), n = t.O(), r = this.index[e] || new Wt(S.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.q(), n = t.O(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Wt(S.N)).W();
    }, t;
}(), Qe = /** @class */ function() {
    function t(t) {
        this.mr = t;
...
var $e = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this._h = V.min(), this.Dn = t.fh(n), this.dh = t.wh(), this.Th = t.Eh(), this.Ih = new Ce(this.dh, this.Dn, this.persistence.mh()), 
        this.ah.Rh(this.Ih)
    ...
    /* Accept locally generated Mutations and commit them to storage. */ t.prototype.gh = function(t) {
        var e, n = this, r = R.now(), i = t.reduce((function(t, e) {
            return t.add(e.key);
        }), ee());
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof Dt && h.version.isEqual(V.min()) ? (
    ...
    t.prototype.ao = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.no(o, t.ee()).next((function(t) {
                ...
                return n.ah.Bn(o, t, e ? r : V.min(), e ? i : ee());
            })).next((function(t) {
                return {
                    documents: t,
                    co: i
...
var Ze = /** @class */ function() {
    ...
    return t.do = function(t, e) {
        return O.N(t.key, e.key) || ke(t.po, e.po);
    }, 
    /** Compare by ID then by key */ t.To = function(t, e) {
        return ke(t.po, e.po) || O.N(t.key, e.key);
    }, t;
}();
...
function Qn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof R || t instanceof Ln || t instanceof Nn || t instanceof Mn || t instanceof Dn);
}
 ...
 */ var Xn = /** @class */ function() {
    ...
    return t(n, e), n.prototype.Ra = function(t) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 6:
                    ...
                    r.isEqual(V.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;
...
n) {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Fc.tc(t, "rejected", r), e = this.Mc.get(t), (i = e && e.key) ? (o = (o = new Gt(O.N)).Re(i, new Dt(i, V.min())), 
                    s = ee().add(i), u = new ue(V.min(), 
    ...
    return t.prototype.Rh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(V.min()) ? this.pl(t, e) : this.Vl.qn(t, r).next((function(o) {
            var u = i.yl(e, o);
    ...
    return t.prototype.vl = function(t) {
        ...
        // because it precedes all other segments in an ordered traversal.
                O.et(i) || (i = i.child(""));
        var o = new tn(new O(i), 0), s = new Wt(ke);
...
var Dr = /** @class */ function() {
    ...
    return t.prototype.j_ = function(t) {
        ...
        var e = X(t), n = new R(e.seconds, e.nanos);
    ...
    function t(t) {
        ...
        hn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Xe.hh; else {
            if (t.cacheSizeBytes !== Rr && t.cacheSizeBytes < Xe.rh) throw new I(E.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Xe.rh);
 ...
 */        if (!n || "string" != typeof n) throw new I(E.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return this.tf(), new Mr(new kt(S.H, t), this, 
        /* converter= */ null);
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        if (s.Y()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new I(E.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === o) {
                this.Sf(r, o);
        ...
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new I(E.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
    ...
    /** Helper function to create a bound from a document or fields */ t.prototype.Nf = function(t, e, n, r) {
        if (yn(t, 1, e), e instanceof Lr) {
            if (n.length > 0) throw new I(E.INVALID_ARGUMENT, "Too many arguments provided to " + t + "().");
            var i = e;
    ...
    t.prototype.$f = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.vf.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(Z(this.firestore.xo, t.key)); else {
                var s = t.field(o.field);
                if (j(s)) throw new I(E.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.j();
                    throw new I(E.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.Lf = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                var u = this.vf.path.child(S.G(s));
    ...
    t.prototype.Cf = function(t) {
        if ("string" == typeof t) {
            ...
            var e = this.vf.path.child(S.G(t));
            ...
            return Z(this.firestore.xo, new O(e));
        }
        if (t instanceof Pr) {
            var n = t;
            return Z(this.firestore.xo, n.Bo);
        }
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        if (e && this.Mf.hs) throw new I(E.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, kt.Wt(t), n, r) || this).Qf = t, t.length % 2 != 1) throw new I(E.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
...
var Hr = Wr(kr, "Use firebase.firestore() instead."), Yr = Wr(Sr, "Use firebase.firestore().runTransaction() instead."), Kr = Wr(Ur, "Use firebase.firestore().batch() instead."), Xr = Wr(Pr, "Use firebase.firestore().doc() instead."), $r = Wr(Lr), Jr = Wr(qr), Zr = Wr(Mr), ti = Wr(Cr), ei = Wr(Fr, "Use firebase.firestore().collection() instead."), ni = Wr(Pn, "Use FieldValue.<field>() instead."), ri = Wr(Nn, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), ii = {
     ...
     */    return t.prototype.od = function(t, e) {
        ...
        var n = [ this.hd, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = m(), o = {
        ...
        return N(g.EventType.OPEN, (function() {
            ...
            }("Connection", "WebChannel transport errored:", t), b.nd(new I(E.UNAVAILABLE, "The operation could not be completed")));
