...
var T = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (Se("string" == typeof n.accessToken), new N(n.accessToken, t.currentUser)) : null;
...
/** Extracts the backend's type order for the provided value. */ function K(t) {
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Q(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return Ve(t.arrayValue.values || [], e.arrayValue.values || [], Q);
...
function H(t, e) {
    ...
    var n = Z(t), r = Z(e), i = ke(n.seconds, r.seconds);
...
var at = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Ve(this.elements, e.elements, Q);
    }, t;
}(), ct = /** @class */ function() {
    function t(t) {
        this.elements = t;
...
e) {
     ...
     */
    t.wt = function(t) {
        return t instanceof xt ? t.version : R.min();
    }, t;
}(), mt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    n.prototype.gt = function(t) {
        var e;
        return e = t instanceof xt ? t.data() : Tt.empty(), this.pt(e);
    }, n.prototype.pt = function(t) {
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        if (this.It(t), Se(null != e.transformResults), !this.Rt.Et(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
    ...
    n.prototype.vt = function(t, e) {
        ...
        for (var r = 0; r < e.length; r++) {
            ...
            t instanceof xt && (s = t.field(i.field)), n.push(o.at(s, e[r]));
        }
        return n;
    }, 
    /**
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        ...
        return this.It(t), this.Rt.Et(t) ? new St(this.key, R.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var _t, At, Dt = function(t, e) {
    ...
    function n(t, n, r, i) {
        var o = this;
        return (o = e.call(this, t, n) || this).kt = r, o.At = !!i.At, o.hasCommittedMutations = !!i.hasCommittedMutations, 
        o;
    }
    ...
    function t(t, e, n, r, i, o, s) {
        ...
        this.startAt = o, this.endAt = s, this.xt = null;
    }
    ...
    return t.Wt = function(e) {
        ...
        get: function() {
            if (null === this.qt) {
                ...
                t.Y() || this.qt.push(new jt(t)), this.qt.push(new jt(O.J(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.ee = function() {
        if (!this.Ut) if ("F" /* First */ === this.Bt) this.Ut = new Pt(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            for (
            ...
            // Now return as a LimitType.First query.
                        this.Ut = new Pt(this.path, this.collectionGroup, t, this.filters, this.limit, o, s);
        }
        return this.Ut;
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Ut(t, r) : "in" /* IN */ === e ? new Ct(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Mt(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && K(this.value) === K(e) && this.de(J(e, this.value));
        ...
        return this.field.j() + this.op.toString() + X(this.value);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && Q(this.value, t.value);
    }, n.prototype.toString = function() {
        return this.field.j() + " " + this.op + " " + X(this.value);
    }, n;
     ...
     */ , s) {
        void 0 === i && (i = R.min()), void 0 === o && (o = R.min()), void 0 === s && (s = q.ht), 
...
var Wt = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.N, this.root.Ae(e, n, this.N).me(null, null, Qt.Pe, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.N, this.root.remove(e, this.N).me(null, null, Qt.Pe, null, null));
    }, 
    ...
    t.prototype.be = function() {
        return new Kt(this.root, null, this.N, !1);
    }, t.prototype.ve = function(t) {
        return new Kt(this.root, t, this.N, !1);
    }, t.prototype.Se = function() {
        return new Kt(this.root, null, this.N, !0);
    }, t.prototype.De = function(t) {
        return new Kt(this.root, t, this.N, !0);
    }, t;
}(), Kt = /** @class */ function() {
    function t(t, e, n, r) {
        this.Ce = r, this.Fe = [];
    ...
    t.prototype.Ae = function(t, e, n) {
        ...
        var e = this;
        return e.left.Le() || e.left.left.Le() || (e = e.Oe()), (e = e.me(null, null, null, e.left.xe(), null)).Me();
    }, 
    // Returns new tree, with the specified item removed.
    t.prototype.remove = function(e, n) {
        var r, i = this;
        if (n(e, i.key) < 0) i.left.B() || i.left.Le() || i.left.left.Le() || (i = i.Oe()), 
        i = i.me(null, null, null, i.left.remove(e, n), null); else {
            if (i.left.Le() && (i = i.Be()), i.right.B() || i.right.Le() || i.right.left.Le() || (i = i.qe()), 
            0 === n(e, i.key)) {
                if (i.right.B()) return t.EMPTY;
                r = i.right.min(), i = i.me(r.key, r.value, null, null, i.right.xe());
            }
    ...
    t.prototype.Me = function() {
        var t = this;
        return t.right.Le() && !t.left.Le() && (t = t.Ue()), t.left.Le() && t.left.left.Le() && (t = t.Be()), 
        t.left.Le() && t.right.Le() && (t = t.Qe()), t;
    }, t.prototype.Oe = function() {
        var t = this.Qe();
        return t.right.left.Le() && (t = (t = (t = t.me(null, null, null, null, t.right.Be())).Ue()).Qe()), 
        t;
    ...
    t.prototype.je = function() {
        if (this.Le() && this.left.Le()) throw xe();
        if (this.right.Le()) throw xe();
        var t = this.left.je();
 ...
 */ var se = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, he.ds(e, n)), new t(R.min(), r, oe(), Xt(), re());
    }, t;
}(), he = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = q.ht), void 0 === r && (r = null), this.state = t, this.targetIds = e, 
    ...
    return t.prototype.qs = function(t) {
        for (var e = 0, n = t.ws; e < n.length; e++) {
            var r = n[e];
            t.Rs instanceof xt ? this.Us(r, t.Rs) : t.Rs instanceof St && this.Qs(r, t.key, t.Rs);
        }
    ...
    t.prototype.js = function(t, e) {
        var n = this;
        t.targetIds.length > 0 ? t.targetIds.forEach(e) : this.xs.forEach((function(t, r) {
            n.Gs(r) && e(r);
        }));
    }, 
    /**
    ...
    t.prototype.Hs = function(t) {
        ...
        if (r) {
            ...
            if (i.Lt()) if (0 === n) {
                ...
                // queries.
                var o = new L(i.path);
                this.Qs(e, o, new St(o, R.min()));
            } else Se(1 === n); else this.Js(e) !== n && (
    ...
    t.prototype.Xs = function(t) {
        ...
        this.xs.forEach((function(r, i) {
            ...
            if (o) {
                if (r.fs && o.target.Lt()) {
                    ...
                    null !== e.Ls.get(s) || e.Zs(i, s) || e.Qs(i, s, new St(s, t));
                }
        ...
        var i = new ce(t, n, this.Bs, this.Ls, r);
        return this.Ls = Xt(), this.Os = ve(), this.Bs = new Yt(ke), i;
    }, 
    /**
    ...
    t.prototype.Qs = function(t, e, n) {
        if (this.Gs(t)) {
            ...
            r.Fs(e), this.Os = this.Os.Ae(e, this.ti(e).delete(t)), n && (this.Ls = this.Ls.Ae(e, n));
        }
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.xs.get(t);
        return e || (e = new de, this.xs.set(t, e)), e;
    }, t.prototype.ti = function(t) {
        var e = this.Os.get(t);
        return e || (e = new Yt(ke), this.Os = this.Os.Ae(t, e)), e;
    }, 
    /**
    ...
    t.prototype.zs = function(t) {
        var e = this;
        this.xs.set(t, new de), this.Ms.ei(t).forEach((function(n) {
 ...
 */ var ge = {
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (Se(void 0 === t || "string" == typeof t), q.fromBase64String(t || "")) : (Se(void 0 === t || t instanceof Uint8Array), 
        q.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.C(t.C());
    }, t.prototype.fromVersion = function(t) {
        return Se(!!t), R.v(this.v(t));
        ...
        // in the local target cache.
                return 4 === e.length ? k.G : this.Ti(e);
    }, Object.defineProperty(t.prototype, "wi", {
        get: function() {
            return new k([ "projects", this.ii.projectId, "databases", this.ii.database ]).j();
        },
        enumerable: !0,
        configurable: !0
        ...
        return Se(t.length > 4 && "documents" === t.get(4)), t.k(5);
    }, 
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ri = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            }), f = new xt(a, c, h, {}), l = u.targetIds || [], p = u.removedTargetIds || [];
            e = new fe(l, p, f.key, f);
        } else if ("documentDelete" in t) {
            t.documentDelete;
            var d = t.documentDelete;
            d.document;
            var y = this.Z(d.document), v = d.readTime ? this.fromVersion(d.readTime) : R.min(), m = new St(y, v), g = d.removedTargetIds || [];
            e = new fe([], g, m.key, m);
        ...
        if (t.transform) {
            ...
            return Se(!0 === n.exists), new wt(u, a);
        }
        if (t.verify) {
        ...
        var e = null;
        if ("setToServerValue" in t) Se("REQUEST_TIME" === t.setToServerValue), e = ut.instance; else if ("appendMissingElements" in t) {
            var n = t.appendMissingElements.values || [];
            e = new at(n);
        } else if ("removeAllFromArray" in t) {
            var r = t.removeAllFromArray.values || [];
            e = new ct(r);
        } else "increment" in t ? e = new ht(this, t.increment) : xe();
        ...
        var h = null;
        return n.endAt && (h = this.Gi(n.endAt)), new kt(e, i, u, s, a, "F" /* First */ , c, h).ee();
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof Vt ? e.Yi(t) : xe();
            }));
...
function(t, e, n, r, i) {
    ...
    t.prototype.Mn = function(t, e) {
        this.$n();
        var n = this.Dn.get(e);
        return void 0 !== n ? je.resolve(n) : this.xn(t, e);
    }, 
    /**
    ...
    t;
}(), Be = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Ge = /** @class */ function() {
    function t() {
        this.Bn = [];
    }
    ...
    t.prototype.Jn = function(t, e) {
        ...
        return this.Wn.Xn(t, e).next((function(r) {
            var i = n.Hn(t, e, r), o = Xt();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new St(t, R.min())), o = o.Ae(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.Zn = function(t, e, n) {
        ...
        return this.Kn(t, new L(e)).next((function(t) {
            var e = te();
            return t instanceof xt && (e = e.Ae(t.key, t)), e;
        }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.rr(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    r = f instanceof xt ? r.Ae(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        return this.Qn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof xt && (c = c.Ae(t, e));
            })), c;
        }));
    }, t;
}(), We = /** @class */ function() {
...
/** Represents the database ID a Firestore client is associated with. */ Ke.dr = -1;
 ...
 */
function Je(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = Xe(e)), e = He(t.get(n), e);
    return Xe(e);
}
 ...
 */ function Ze(t) {
    ...
    var e = t.length;
    if (Se(e >= 2), 2 === e) return Se("" === t.charAt(0) && "" === t.charAt(1)), 
    k.G;
 ...
 */ var $e = /** @class */ function() {
    ...
    return t.prototype.Dr = function(t, e) {
        return this.Sr.add(e), je.resolve();
    }, t.prototype.ir = function(t, e) {
        return je.resolve(this.Sr.getEntries(e));
    }, t;
}(), tn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.O(), n = t.M(), r = this.index[e] || new Yt(k.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.O(), n = t.M(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Yt(k.N)).W();
    }, t;
}(), en = /** @class */ function() {
    function t() {
        /**
 ...
 */ var rn = /** @class */ function() {
    ...
    t.prototype.Or = function(t, e) {
        ...
        return sn(t).Ur({
            ...
            o && o.isEqual(s) && (
            // Key found in cache.
            n(o, e), o = i.$e() ? i.Ne() : null), 
            // Skip to the next key (if there is one).
            o ? r.Qr(o.path.W()) : r.done();
        })).next((function() {
            // The rest of the keys are not in the cache. One case where `iterate`
            // above won't go through them is when the cache is empty.
            for (;o; ) n(o, null), o = i.$e() ? i.Ne() : null;
        }));
    }, t.prototype.Zn = function(t, e, n) {
        ...
        return sn(t).Ur(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                ...
                e.path.q(u.key.path) ? u instanceof xt && e.matches(u) && (i = i.Ae(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    ...
    t.prototype.Kr = function(t, e) {
        var n = this, r = Xt(), i = this.serializer.Wr(e), o = sn(t), s = IDBKeyRange.lowerBound(i, !0);
        return o.Ur({
    ...
    t.prototype.kr = function(t) {
        if (t) {
            ...
            return e instanceof St && e.version.isEqual(R.min()) ? null : e;
        }
        return null;
    }, t;
}();
...
/** Offset to ensure non-overlapping target ids. */ rn.Jr = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.On = function(t) {
        ...
        return this.Dn.forEach((function(o, s) {
            ...
            if (s) {
                ...
                var h = e.th.serializer.sh(new St(o, R.min()), e.readTime);
                n.push(e.th.Nn(t, o, h));
            } else n.push(e.th.kn(t, o));
        })), i.forEach((function(r) {
            n.push(e.th.jn.Dr(t, r));
        })), n.push(this.th.updateMetadata(t, r)), je.vn(n);
...
var cn = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.ah(t).next((function(t) {
            return R.v(new S(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.Rh(t, e.targetId).next((function() {
            ...
            return Se(e.targetCount > 0), e.targetCount -= 1, n.uh(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.Eh = function(t, e) {
        ...
        // depends on the queryTargets index to be efficient.
                return fn(t).Ur({
            range: i,
            index: qn.queryTargetsIndexName
        }, (function(t, r, i) {
        ...
        // IndexedDb.
            ...
            var s = Je(e.path);
            i.push(o.put(new jn(n, s))), i.push(r.hh.yh(t, n, e));
        })), je.vn(i);
    }, t.prototype.bh = function(t, e, n) {
        var r = this, i = pn(t);
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        // IndexedDb.
                return je.forEach(e, (function(e) {
            var o = Je(e.path);
            return je.vn([ i.delete([ n, o ]), r.hh.vh(t, n, e) ]);
        }));
...
/** Serializer for values stored in the LocalStore. */ var dn = /** @class */ function() {
    ...
    /** Encodes a document for storage locally. */ t.prototype.sh = function(t, e) {
        var n = this.Wr(e), r = t.key.path.M().W();
        if (t instanceof xt) {
        ...
        if (t instanceof St) {
            var s = t.key.path.W(), u = this.$h(t.version), a = t.hasCommittedMutations;
            return new Cn(
            /* unknownDocument= */ null, new Ln(s, u), 
            /* document= */ null, a, n, r);
        }
        if (t instanceof Rt) {
            var c = t.key.path.W(), h = this.$h(t.version);
    ...
    /** Encodes a batch of mutations into a DbMutationBatch for local storage. */ t.prototype.kh = function(t, e) {
    ...
    /** Decodes a DbTarget into TargetData */ t.prototype.mh = function(t) {
        ...
        return e = void 0 !== t.query.documents ? this.Fh.Oi(t.query) : this.Fh.Wi(t.query), 
        new Ft(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, n, r, q.fromBase64String(t.resumeToken));
    }, 
    /** Encodes TargetData into a DbTarget for storage locally. */ t.prototype.Ph = function(t) {
        var e, n = this.$h(t.Ee), r = this.$h(t.lastLimboFreeSnapshotVersion);
        e = t.target.Lt() ? this.Fh.Li(t.target) : this.Fh.Bi(t.target);
        // We can't store the resumeToken as a ByteString in IndexedDb, so we
        // convert it to a base64 string for storage.
        var i = t.resumeToken.toBase64();
        // lastListenSequenceNumber is always 0 until we do real GC.
                return new qn(t.targetId, t.target.canonicalId(), n, i, t.sequenceNumber, r, e);
    }, t;
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).xh = t, r.Lh = n, r;
    }
    return t(n, e), n;
}(Ge), mn = /** @class */ function() {
    function t(
    /**
    ...
    c) {
        ...
        this.Tr = s, this.Oh = a, this.Bh = c, this.qh = null, this.Uh = !1, this.isPrimary = !1, 
    ...
    return t.Nr = function(t, e) {
        if (t instanceof vn) return Kn.Nr(t.xh, e);
        throw xe();
    }, 
    /**
    ...
    t.prototype.start = function() {
        var t = this;
        return Kn.Zh(this.Hh, xn, new Sn(this.serializer)).then((function(e) {
            return t.to = e, t.eo();
        })).then((function() {
    ...
    t.prototype.eo = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return wn(e).put(new zn(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
    ...
    t.prototype.do = function(t) {
        var e = this;
        return this.Bh ? je.resolve(!0) : gn(t).get(Pn.key).next((function(n) {
    ...
    t.prototype.So = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return t.zh() ? (e = r + t.Yh, [ 4 /*yield*/ , Kn.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
        ...
        return this.to.runTransaction(o, Wn, (function(o) {
            return i = new vn(o, r.qh ? r.qh.next() : Ke.dr), "readwrite-primary" === e ? r._o(i).next((function(t) {
                return !!t || r.do(i);
            })).next((function(e) {
    ...
    t.prototype.To = function(t) {
        var e = new Pn(this.clientId, this.allowTabSynchronization, Date.now());
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.fo = function(t) {
        var e = this, n = gn(t);
        return n.get(Pn.key).next((function(t) {
            return e.Eo(t) ? (_e("IndexedDbPersistence", "Releasing primary lease."), n.delete(Pn.key)) : je.resolve();
        }));
    }, 
...
var En = /** @class */ function() {
    function t(t, e) {
        this.db = t, this.xo = new cr(this, e);
    }
            ...
            if (u <= e) {
                var a = n.Qo(t, s).next((function(e) {
                    ...
                    return o++, r.Mn(t, s).next((function() {
                        return r.kn(s), pn(t).delete([ 0, Je(s.path) ]);
                    }));
                }));
                i.push(a);
            }
...
/** A mutation queue for a specific user, backed by IndexedDB. */ var Tn = /** @class */ function() {
    ...
    return t.Co = function(e, n, r, i) {
        ...
        return Se("" !== e.uid), new t(e.t() ? e.uid : "", n, r, i);
        ...
        return s.add({}).next((function(u) {
            Se("number" == typeof u);
            for (var a = new Me(u, e, n, r), c = i.serializer.kh(i.userId, a), h = [], f = new Yt((function(t, e) {
                return ke(t.j(), e.j());
            })), l = 0, p = r; l < p.length; l++) {
                var d = p[l], y = On.key(i.userId, d.key.path, u);
                f = f.add(d.key.path.M()), h.push(s.put(c)), h.push(o.put(y, On.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.jn.Dr(t, e));
            })), t.qn((function() {
                i.zo[u] = a.keys();
            })), je.vn(h).next((function() {
                return a;
            }));
        }));
    }, t.prototype.Jo = function(t, e) {
        ...
        return _n(t).get(e).next((function(t) {
            return t ? (Se(t.userId === n.userId), n.serializer.Mh(t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Xo = function(t, e) {
        var n = this;
        return this.zo[e] ? je.resolve(this.zo[e]) : this.Jo(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.zo[e] = r, r;
            }
        ...
        return _n(t).Ur({
            ...
            e.userId === n.userId && (Se(e.batchId >= r), o = n.serializer.Mh(e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        // the given documentKey.
            ...
            return _n(t).get(c).next((function(t) {
                if (!t) throw xe();
                Se(t.userId === n.userId), o.push(n.serializer.Mh(t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        return e.forEach((function(e) {
            ...
            i.push(u);
        })), je.vn(i).next((function() {
            return n.sa(t, r);
        }));
    }, t.prototype.nr = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = On.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Yt(ke);
        return An(t).Ur({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], c = t[2], h = Ze(a);
            s === n.userId && r.q(h) ? 
        ...
        return e.forEach((function(e) {
            i.push(_n(t).get(e).next((function(t) {
                if (null === t) throw xe();
                Se(t.userId === n.userId), r.push(n.serializer.Mh(t));
            })));
        })), je.vn(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return Nn(t.xh, this.userId, e).next((function(r) {
            return t.qn((function() {
                n.na(e.batchId);
            })), je.forEach(r, (function(e) {
                return n.hh.Uo(t, e);
            }));
        }));
    }, 
 ...
 */ var xn = 10, Sn = /** @class */ function() {
     ...
     */    return t.prototype.createOrUpgrade = function(t, e, n, r) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(jn.store), t.deleteObjectStore(qn.store), t.deleteObjectStore(Fn.store);
        }(t), Gn(t)), s = s.next((function() {
            /**
     ...
     */
        ...
        return t.store(Cn.store).Ur((function(t, n) {
            ...
            var n = new Mn(e);
            return t.store(Mn.store).put(Mn.key, n);
        }));
    }, t.prototype.removeAcknowledgedMutations = function(t) {
        var e = this, n = t.store(kn.store), r = t.store(Vn.store);
        return n.Fr().next((function(n) {
            return je.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Fr(Vn.userMutationsIndex, i).next((function(r) {
                    return je.forEach(r, (function(r) {
                        Se(r.userId === n.userId);
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        var e = t.store(jn.store), n = t.store(Cn.store);
        return t.store(Fn.store).get(Fn.key).next((function(t) {
            ...
            return n.Ur((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? je.resolve() : function(n) {
                        return e.put(new jn(0, Je(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return je.vn(r);
        ...
        // Index existing remote documents.
            ...
            return e.store(On.store).Ur({
                ...
                t[0];
                var n = t[1], r = (t[2], Ze(n));
                return i(r.M());
            }));
        }));
    }, t.prototype.rewriteCanonicalIds = function(t) {
        var e = this, n = t.store(qn.store);
...
Mn.store = "remoteDocumentGlobal", Mn.key = "remoteDocumentGlobalKey";
...
qn.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
qn.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store. */ function Gn(t) {
    ...
    t.createObjectStore(qn.store, {
        keyPath: qn.keyPath
    }).createIndex(qn.queryTargetsIndexName, qn.queryTargetsKeyPath, {
        unique: !0
...
var Wn = r(r(r([ kn.store, Vn.store, On.store, Cn.store, qn.store, Pn.store, Fn.store, jn.store ], [ zn.store ]), [ Mn.store ]), [ Bn.store ]), Kn = /** @class */ function() {
    function t(e) {
        this.db = e, 
    ...
    return t.Zh = function(e, n, r) {
        return _e("SimpleDb", "Opening database:", e), new je((function(i, o) {
            ...
            s.onsuccess = function(e) {
                ...
                r.createOrUpgrade(n, s.transaction, t.oldVersion, xn).next((function() {
                    _e("SimpleDb", "Database upgrade to version " + xn + " complete");
                }));
            };
        })).yn();
    }, 
    /** Deletes the specified database. */ t.delete = function(t) {
        return _e("SimpleDb", "Removing database:", t), Zn(window.indexedDB.deleteDatabase(t)).yn();
    }, 
                  ...
                  case 0:
                    e = "readonly" === t, o = 0, s = function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                ++o, t = Hn.open(u.db, e ? "readonly" : "readwrite", r), n.label = 1;
 ...
 */ var Hn = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             */
        this.Ea = new Qe, this.transaction.oncomplete = function() {
            e.Ea.resolve();
    ...
    t.prototype.add = function(t) {
        return _e("SimpleDb", "ADD", this.store.name, t, t), Zn(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return Zn(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), _e("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return _e("SimpleDb", "DELETE", this.store.name, t), Zn(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return _e("SimpleDb", "COUNT", this.store.name), Zn(this.store.count());
 ...
 */ var er = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Ra = t, this.Er = e, this.Aa = n, this.op = r, this.ma = i, this.Pa = new Qe, 
    ...
    return Object.defineProperty(t.prototype, "ka", {
    ...
    t.prototype.Ba = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.xa(), this.va ? [ 3 /*break*/ , 2 ] : (this.va = !0, (e = Te.nt().window) && e.removeEventListener("visibilitychange", this.$a), 
                    [ 4 /*yield*/ , this.Oa(t) ]);
...
function ir(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], s = ke(n, i);
    return 0 === s ? ke(r, o) : s;
}
...
var ar = /** @class */ function() {
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return n.trys.push([ 1, 3, , 7 ]), [ 4 /*yield*/ , t.Tu(this.xo) ];
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.wu = function(t, e) {
        var n = this;
        if (0 === e) return je.resolve(Ke.dr);
        var r = new or(e);
    ...
    t.prototype.jo = function(t, e) {
        ...
        je.resolve(sr)) : this.Go(t).next((function(r) {
    ...
    t, e, n) {
        ...
        /**
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
        this.gu = R.min(), this.Wn = t.Do(n), this.pu = t.No(), this.Jh = t.Fo(), this.yu = new ze(this.pu, this.Wn, this.persistence.$o()), 
        this.mu.bu(this.yu)
                  ...
                  case 0:
                    return e = this.Wn, r = this.yu, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        ...
                        return o.Wn.ea(n).next((function(s) {
                            ...
                            // MutationQueue.
                            r = new ze(o.pu, e, o.persistence.$o()), e.ea(n);
                        })).next((function(t) {
    ...
    t.prototype.Nu = function(t) {
        ...
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(n) {
            ...
            return e.$u(n, t, i).next((function() {
                return i.apply(n);
            })).next((function() {
                return e.Wn.ra(n);
            })).next((function() {
    ...
    t.prototype.ku = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.Wn.Jo(n, t).next((function(t) {
                return Se(null !== t), r = t.keys(), e.Wn.ia(n, t);
            })).next((function() {
                return e.Wn.ra(n);
            })).next((function() {
                return e.yu.Yn(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            e.as.forEach((function(e, s) {
                ...
                if (a) {
                    ...
                    // Update the resume token if the change includes one.
                                        if (c.rt() > 0) {
                        var h = a.we(c, r).Ie(o.Lh);
                        i = i.Ae(s, h), 
                        // Update the target data if there are target changes (or if
                        // sufficient time has passed since the last update).
                        t.xu(a, h, e) && u.push(n.Jh.Ih(o, h));
                    }
                }
            }));
            var a = Xt(), c = re();
            ...
            u.push(s.getEntries(o, c).next((function(t) {
                e.cs.forEach((function(i, c) {
                    ...
                    // cache.
                                        c instanceof St && c.version.isEqual(R.min()) ? (
                    // NoDocuments with SnapshotVersion.min() are used in manufactured
                    // events. We remove these documents from cache since we lost
                    // access.
                    s.kn(i, r), a = a.Ae(i, c)) : null == h || c.version.S(h.version) > 0 || 0 === c.version.S(h.version) && h.hasPendingWrites ? (s.Nn(c, r), 
                ...
                var h = n.Jh._h(o).next((function(t) {
                    return n.Jh.dh(o, o.Lh, r);
                }));
                u.push(h);
            }
            return je.vn(u).next((function() {
                return s.apply(o);
            })).next((function() {
                return n.yu.Jn(o, a);
            }));
    ...
    t.xu = function(t, e, n) {
        ...
        return Se(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.Ee.D() - t.Ee.D() >= this.Lu || n.Ts.size + n.Es.size + n.Is.size > 0);
                  ...
                  case 0:
                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return je.forEach(t, (function(t) {
                            return je.forEach(t.hr, (function(n) {
                                return h.persistence.hh.yh(e, t.targetId, n);
                            })).next((function() {
                                return je.forEach(t.or, (function(n) {
    ...
    t.prototype.Uu = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Jh.gh(n, t).next((function(i) {
                ...
                r = i, je.resolve(r)) : e.Jh.oh(n).next((function(i) {
                    return r = new Ft(t, i, 0 /* Listen */ , n.Lh), e.Jh.fh(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.gh = function(t, e) {
        var n = this.Vu.get(e);
        return void 0 !== n ? je.resolve(this.Pu.get(n)) : this.Jh.gh(t, e);
    }, 
    /**
    ...
    t.prototype.Qu = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? je.resolve() : n.persistence.hh.removeTarget(t, r);
        })).then((function() {
    ...
    /** Returns the local view of the documents affected by a mutation batch. */ i.prototype.Gu = function(t) {
        ...
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", (function(n) {
            return e.Wn.Xo(n, t).next((function(t) {
                return t ? e.yu.Yn(n, t) : je.resolve(null);
            }));
        }));
 ...
 */ var pr = /** @class */ function() {
    ...
    return t.Ju = function(t, e) {
        return L.N(t.key, e.key) || ke(t.hc, e.hc);
    }, 
    /** Compare by ID then by key */ t.Zu = function(t, e) {
        return ke(t.hc, e.hc) || L.N(t.key, e.key);
    }, t;
}();
 ...
 */ function Nr(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new I(T.INVALID_ARGUMENT, "Invalid value " + Dr(r) + " provided to function " + t + "() for its " + kr(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}
...
function xr(t, e, n) {
    if (void 0 === n) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + kr(e) + " argument, but it was undefined.");
}
 ...
 */ function Rr(t, e, n, r) {
    var i = Dr(r);
    return new I(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + kr(n) + " argument to be a " + e + ", but it was: " + i);
}

function Pr(t, e, n) {
    if (n <= 0) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + kr(e) + " argument to be a positive number, but it was: " + n + ".");
}
...
var qr = new RegExp("[~\\*/\\[\\]]"), jr = function() {
...
}(jr), Kr = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.delete = function() {
        return yr("FieldValue.delete", arguments), new Qr(new Fr("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return yr("FieldValue.serverTimestamp", arguments), new Qr(new Br("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return mr("FieldValue.arrayUnion", arguments, 1), new Qr(new Gr("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return mr("FieldValue.arrayRemove", arguments, 1), new Qr(new zr("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return wr("FieldValue.increment", "number", 1, t), vr("FieldValue.increment", arguments, 1), 
        new Qr(new Wr("FieldValue.increment", t));
    }, n;
     ...
     */
    t.prototype.p = function(t) {
        return ke(this.Rc, t.Rc) || ke(this.Ac, t.Ac);
    }, t;
}(), Jr = /^__.*__$/, Hr = function(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ var ti = /** @class */ function() {
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if ($r(this.fc) && Jr.test(t)) throw this.Tc('Document fields cannot begin and end with "__"');
    }, t;
}(), ei = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.prototype.Fc = function(t, e, n) {
        ...
        return new Xr(new Tt(s), i, o);
    }, 
    /** Parse update data from an update() call. */ t.prototype.$c = function(t, e) {
        var n = this.Nc(1 /* Update */ , t);
        oi("Data must be an object, but it was:", n, e);
        var r = [], i = new It;
        C(e, (function(e, o) {
            var s = ui(t, e), u = n.Sc(s);
            if (o instanceof jr && o._c instanceof Fr) 
        ...
        var o = new lt(r);
        return new Zr(i.yt(), o, n.fieldTransforms);
    }, 
    /** Parse update data from a list of field/value arguments. */ t.prototype.kc = function(t, e, n, r) {
        ...
        for (var a = [], c = new It, h = o.length - 1; h >= 0; --h) if (!ai(a, o[h])) {
            ...
            if (l instanceof jr && l._c instanceof Fr) 
            // Add it to the field mask, but don't add anything to updateData.
            a.push(f); else {
                var d = ni(l, p);
        ...
        var y = new lt(a);
        return new Zr(c.yt(), y, i.fieldTransforms);
    }, 
...
function ni(t, e) {
    ...
    return function(t, e) {
        ...
        if (!$r(e.fc)) throw e.Tc(t.lc + "() can only be used with update() and set()");
...
function ii(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof S || t instanceof Yr || t instanceof Ur || t instanceof Hr || t instanceof jr);
}
 ...
 */ function ui(t, e) {
    try {
        return function(t) {
            if (t.search(qr) >= 0) throw new I(T.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (Mr.bind.apply(Mr, r([ void 0 ], t.split("."))));
            } catch (e) {
 ...
 */ var ci = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        this.Tr = t, this.xc = n, this.Lc = r, this.Oc = i, this.listener = o, this.state = 0 /* Initial */ , 
        /**
    ...
    t.prototype.Kc = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.Qc() && null === this.qc && (this.qc = this.Tr.yr(this.xc, 6e4, (function() {
            return t.Gc();
        })));
    }, 
    ...
    n.prototype.start = function() {
        this.o_ = !1, this.lastStreamToken = q.ht, e.prototype.start.call(this);
    }, n.prototype.Yc = function() {
        this.o_ && this.u_([]);
    }, n.prototype.e_ = function(t) {
        return this.Lc.i_("Write", t);
    }, n.prototype.onMessage = function(t) {
        if (
        // Always capture the last stream token.
        Se(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.o_) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.Na.reset();
            var e = this.serializer.xi(t.writeResults, t.commitTime), n = this.serializer.fromVersion(t.commitTime);
            return this.listener.c_(n, e);
        }
        // The first response is always the handshake response
                return Se(!t.writeResults || 0 === t.writeResults.length), this.o_ = !0, 
        this.listener.__();
    }, 
    /**
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).Lc = t, i.credentials = n, i.serializer = r, i.f_ = !1, 
        i;
    }
                ...
                switch (o.label) {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof St || t instanceof xt ? i.p_(t) : xe();
                    })), r) ];
                }
            }));
        }));
    ...
    r, i, o, s) {
        ...
        this.G_ = function(t, e, n) {
            var r = Re(t);
            return new hi(e, r.Lc, r.credentials, r.serializer, n);
        }(this.w_, i, {
            ...
            var r = Re(t);
            return new fi(e, r.Lc, r.credentials, r.serializer, n);
        }(this.w_, i, {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.L_.length > 0 && (_e("RemoteStore", "Stopping write stream with " + this.L_.length + " pending writes"), 
                    this.L_ = []), this.hl(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.Vo = function() {
    ...
    t.prototype.al = function(t) {
        this.O_.delete(t), this.G_.Qc() && this.ul(t), 0 === this.O_.size && (this.G_.Qc() ? this.G_.Kc() : this.W_() && 
    ...
    t.prototype.sl = function() {
        return this.W_() && !this.G_.Uc() && this.O_.size > 0;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.O_.has(o) ? [ 4 /*yield*/ , this.cl.Tl(o, e) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];
    ...
    t.prototype.nl = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    t = this.L_.length > 0 ? this.L_[this.L_.length - 1].batchId : -1, n.label = 1;
                  ...
                  case 3:
                    return null === (e = n.sent()) ? (0 === this.L_.length && this.J_.Kc(), [ 3 /*break*/ , 7 ]) : (t = e.batchId, 
                    this.Il(e), [ 3 /*break*/ , 6 ]);
     ...
     */
    t.prototype.El = function() {
        return this.W_() && this.L_.length < 10;
    }, 
    // For testing
    ...
    t.prototype.Il = function(t) {
        this.L_.push(t), this.J_.Qc() && this.J_.a_ && this.J_.u_(t.mutations);
    }, t.prototype.wl = function() {
        return this.W_() && !this.J_.Uc() && this.L_.length > 0;
    }, t.prototype.Rl = function() {
        this.J_.start();
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                for (t = 0, e = this.L_; t < e.length; t++) r = e[t], this.J_.u_(r.mutations);
                return [ 2 /*return*/ ];
            }));
        }));
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.L_.shift(), i = qe.from(e, t, r), [ 4 /*yield*/ , this.fl((function() {
                        return o.cl.ml(i);
                    })) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return Gt(r = t.code) && r !== T.ABORTED ? (e = this.L_.shift(), 
...
var wi = /** @class */ function() {
    ...
    function t(e, n, r, i, o) {
        ...
        this.b_ = null, this.ur = null, this.Fl = this.Nl.bind(this), this.$l = new Wt(ke), 
        this.ho = !1, 
        /**
             * Captures WebStorage events that occur before `start()` is called. These
             * events are replayed once `WebStorageSharedClientState` is started.
             */
        this.kl = [], !t.zh(this.platform)) throw new I(T.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
        // Escape the special characters mentioned here:
        // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions
                var s = r.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.platform.window.localStorage, this.currentUser = o, this.Ml = vi(this.persistenceKey, this.Cl), 
        this.xl = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.$l = this.$l.Ae(this.Cl, new Ii), this.Ll = new RegExp("^firestore_clients_" + s + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.zh = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.Cl && (o = this.getItem(vi(this.persistenceKey, i))) && (s = bi.bl(i, o)) && (this.$l = this.$l.Ae(s.clientId, s));
                    for (this.Ul(), (u = this.storage.getItem(this.ql)) && (a = this.Ql(u)) && this.Wl(a), 
                    c = 0, h = this.kl; c < h.length; c++) f = h[c], this.Nl(f);
                    return this.kl = [], 
        ...
        this.setItem(this.xl, JSON.stringify(t));
    }, t.prototype.jl = function() {
        return this.Kl(this.$l);
    }, t.prototype.Gl = function(t) {
        var e = !1;
        return this.$l.forEach((function(n, r) {
        ...
        if (t.storageArea === this.storage) {
            if (_e("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.Ml) return void Ae("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Tr.lo((function() {
                return e(r, void 0, void 0, (function() {
                    var e, r, i, o, s, u;
                    return n(this, (function(n) {
                        if (this.ho) {
                            if (null !== t.key) if (this.Ll.test(t.key)) {
                            ...
                            } else t.key === this.xl && (u = function(t) {
                                var e = Ke.dr;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                    Se("number" == typeof n), e = n;
                                } catch (t) {
                                    Ae("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
                            }(t.newValue)) !== Ke.dr && this.ur(u);
                        } else this.kl.push(t);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    t.prototype.Ql = function(t) {
        ...
        var n = this, r = e ? this.$l.Ae(t, e) : this.$l.remove(t), i = this.Kl(this.$l), o = this.Kl(r), s = [], u = [];
        ...
        // state event.
        this.$l.get(t.clientId) && this.b_(t.onlineState);
    ...
    t.prototype.yd = function(t, e) {
        ...
        if (t.pe((function(t, e) {
            var h = i.get(t), f = e instanceof xt ? e : null;
    ...
    t.prototype.kd = function(t) {
        ...
        return this.On(e, /*updateLimboDocuments=*/ !0);
    }, 
    /**
    ...
    function t(t, e, n, r) {
        this.Ra = t, this.w_ = e, this.updateFunction = n, this.Pa = r, this.xd = 5, this.Na = new Ye(this.Ra, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.Ld = function() {
        ...
        try {
            ...
            return !j(e) && e.catch && e.then ? e : (this.Pa.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
        ...
        var e = this;
        this.xd > 0 && this.Ud(t) ? (this.xd -= 1, this.Ra.co((function() {
            return e.Od(), Promise.resolve();
        }))) : this.Pa.reject(t);
...
n) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), o = new xi(t, e.ju), s = o.yd(e.documents), u = he.ds(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.On(s, 
                ...
                switch (n.label) {
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        Se(t.Ts.size + t.Es.size + t.Is.size <= 1), t.Ts.size > 0 ? n.Qd = !0 : t.Es.size > 0 ? Se(n.Qd) : t.Is.size > 0 && (Se(n.Qd), 
                        n.Qd = !1));
                    })), [ 4 /*yield*/ , this.cf(e, t) ];
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.jd.nd(t, "rejected", r), e = this.Xd.get(t), (i = e && e.key) ? (o = (o = new Wt(L.N)).Ae(i, new St(i, R.min())), 
                    s = re().add(i), u = new ce(R.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Yt(ke), o, s), [ 4 /*yield*/ , this.Mu(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.x_.ku(t) ];
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.Ef = function(t) {
        ...
        n || (n = new Wt(ke)), n = n.Ae(t, e), this.tf[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.lf = function() {
        for (;this.Yd.length > 0 && this.Jd.size < this.Kd; ) {
            ...
            this.Xd.set(e, new Pi(t)), this.Jd = this.Jd.Ae(t, e), this.Wd.listen(new Ft(kt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Ke.dr));
        }
    }, 
    // Visible for testing
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.zd.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var n = r && r.as.get(u.targetId), o = u.view.On(t, 
                  ...
                  case 1:
                    return n.sent(), this.Gd.n_(e), [ 4 /*yield*/ , this.x_.Ou(i) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return e = n.sent(), r = t.view.kd(e), [ 2 /*return*/ , (this.Pf && this.hf(t.targetId, r.Fd), 
                    r) ];
                }
            }));
        }));
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 3:
                    ...
                    // other clients.
                    this.df(t, i || null), this.x_.zu(t)) : xe(), n.label = 4;
    ...
    i.prototype.yf = function(t) {
        return new kt(t.path, t.collectionGroup, t.orderBy, t.filters, t.limit, "F" /* First */ , t.startAt, t.endAt);
    }, i.prototype.So = function() {
        return this.x_.So();
    ...
    function t(t, e, n) {
        ...
        /**
             ...
             */
        this.Mf = !1, this.xf = null, this.onlineState = "Unknown" /* Unknown */ , this.options = n || {}
        /**
    ...
    return t.prototype.Cf = function(t) {
        ...
        var o = !1;
        return this.Mf ? this.Lf(t) && (this.kf.next(t), o = !0) : this.Of(t, this.onlineState) && (this.Bf(t), 
        o = !0), this.xf = t, o;
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.Nd = function(t) {
        this.onlineState = t;
        var e = !1;
        return this.xf && !this.Mf && this.Of(this.xf, t) && (this.Bf(this.xf), e = !0), 
        e;
        ...
        var e = this.xf && this.xf.hasPendingWrites !== t.hasPendingWrites;
        return !(!t.rs && !e) && !0 === this.options.includeMetadataChanges;
        // Generally we should have hit one of the cases above, but it's possible
        // to get here if there were only metadata docChanges and they got
        // stripped out.
        }, t.prototype.Bf = function(t) {
        t = ae.os(t.query, t.docs, t.ns, t.fromCache), this.Mf = !0, this.kf.next(t);
    }, t;
}(), Ci = /** @class */ function() {
    function t() {}
    ...
    return t.prototype.Ho = function(t) {
        return je.resolve(0 === this.Wn.length);
    }, t.prototype.Yo = function(t, e, n, r) {
        var i = this.jf;
        this.jf++, this.Wn.length > 0 && this.Wn[this.Wn.length - 1];
        var o = new Me(i, e, n, r);
        this.Wn.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.Kf = this.Kf.add(new dr(a.key, i)), this.jn.Dr(t, a.key.path.M());
        }
        return je.resolve(o);
    }, t.prototype.Jo = function(t, e) {
        return je.resolve(this.Gf(e));
    }, t.prototype.Zo = function(t, e) {
        var n = e + 1, r = this.zf(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return je.resolve(this.Wn.length > i ? this.Wn[i] : null);
    }, t.prototype.ta = function() {
        return je.resolve(0 === this.Wn.length ? -1 : this.jf - 1);
    }, t.prototype.ea = function(t) {
        return je.resolve(this.Wn.slice());
    }, t.prototype.Gn = function(t, e) {
        ...
        // because it precedes all other segments in an ordered traversal.
                L.et(i) || (i = i.child(""));
        var o = new dr(new L(i), 0), s = new Yt(ke);
        ...
        var n = this;
        Se(0 === this.Yf(e.batchId, "removed")), this.Wn.shift();
        var r = this.Kf;
        ...
        return this.Wn.length, je.resolve();
    }, 
    /**
    ...
    t.prototype.kn = function(t) {
        ...
        ; o.$e(); ) {
            var s = o.Ne(), u = s.key, a = s.value, c = a.xr, h = a.readTime;
            if (!e.path.q(u.path)) break;
            h.S(n) <= 0 || c instanceof xt && e.matches(c) && (r = r.Ae(c.key, c));
        }
        return je.resolve(r);
...
var ji = /** @class */ function() {
    ...
    return t.prototype.js = function(t, e) {
        ...
        return je.resolve(this.tT);
    }, t.prototype.oh = function(t) {
        return this.highestTargetId = this.sT.next(), je.resolve(this.highestTargetId);
    }, t.prototype.dh = function(t, e, n) {
        ...
        return this.Th(e), this.targetCount += 1, je.resolve();
    }, t.prototype.Ih = function(t, e) {
        return this.Th(e), je.resolve();
    }, t.prototype.wh = function(t, e) {
        ...
        return this.eT.tc(e, n), je.resolve();
    }, t.prototype.bh = function(t, e, n) {
        this.eT.sc(e, n);
        ...
        return this.eT.ic(e), je.resolve();
    }, t.prototype.Sh = function(t, e) {
        var n = this.eT.rc(e);
        return je.resolve(n);
    }, t.prototype.Ch = function(t, e) {
        return je.resolve(this.eT.Ch(e));
    }, t;
}(), Fi = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.iT = {}, this.qh = new Ke(0), this.Uh = !1, this.Uh = !0, this.hh = t(this), 
        this.Jh = new ji(this), this.jn = new $e, this.Qn = new qi(this.jn, (function(t) {
            return e.hh.nT(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.iT[t.s()];
        return e || (e = new Mi(this.jn, this.hh), this.iT[t.s()] = e), e;
    }, t.prototype.Fo = function() {
        return this.Jh;
    }, t.prototype.No = function() {
        return this.Qn;
        ...
        return je.Sn(Object.values(this.iT).map((function(n) {
            return function() {
                return n.Ch(t, e);
            };
        })));
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Lh = t, n;
    }
    return t(n, e), n;
}(Ge), Gi = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
    ...
    return t.cT = function(e) {
        ...
        return this.aT.yh(n, e), this._T.delete(n), je.resolve();
    }, t.prototype.vh = function(t, e, n) {
        return this.aT.vh(n, e), this._T.add(n), je.resolve();
    }, t.prototype.Uo = function(t, e) {
        return this._T.add(e), je.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return je.forEach(this._T, (function(r) {
        ...
        var n = this;
        return je.Sn([ function() {
            return je.resolve(n.aT.Ch(e));
        }, function() {
...
}(), zi = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Wi = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        ...
        if (t.gT.VT) throw new I(T.FAILED_PRECONDITION, zi);
        return new Fi(Gi.cT);
        ...
        return new ki(this.x_, this.Wd, t.w_, this.jd, t.PT, t.Kd);
    }, t.prototype.clearPersistence = function(t) {
        throw new I(T.FAILED_PRECONDITION, zi);
    }, t;
}(), Ki = /** @class */ function(r) {
    function i() {
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        ...
        var e = mn.Mo(t.yT), n = t.platform.Cc(t.yT.ii);
     ...
     */
    r) {
        this.platform = t, this.yT = e, this.credentials = n, this.Ra = r, this.clientId = Pe.cn()
        /**
    ...
    t.prototype.T_ = function() {
        if (this.Ra.ka) throw new I(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.pl = function(t) {
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return this.T_(), r = new Qe, [ 4 /*yield*/ , this.Ra.enqueue((function() {
                        return e(i, void 0, void 0, (function() {
                            var e, i, o;
                            return n(this, (function(n) {
                                switch (n.label) {
                                  ...
                                  case 1:
                                    return (e = n.sent()) instanceof xt ? r.resolve(e) : e instanceof St ? r.resolve(null) : r.reject(new I(T.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                    [ 3 /*break*/ , 3 ];
                        ...
                        return e(i, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  ...
                                  case 1:
                                    return e = n.sent(), i = new xi(t, e.ju), o = i.yd(e.documents), s = i.On(o, 
        ...
        // shutdown to be a no-op.
                this.CT || this.Ra.co((function() {
            return e.ST.$f(t), Promise.resolve();
        }));
...
var Hi = /** @class */ function() {
    ...
    return t.prototype.LT = function(t) {
        switch (K(t)) {
          case 0 /* NullValue */ :
            return null;
        ...
        return new Yr($(t.latitude), $(t.longitude));
        ...
        var e = k.K(t);
        Se(be(e));
        var n = new Ue(e.get(1), e.get(3)), r = new L(e.k(5));
    ...
    function t(t) {
        ...
        Tr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = ur.uu; else {
            if (t.cacheSizeBytes !== Xi && t.cacheSizeBytes < ur.au) throw new I(T.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + ur.au);
    ...
    return Object.defineProperty(t.prototype, "tE", {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                ...
                return t = new Qe, [ 2 /*return*/ , (this.KT.Ma((function() {
                    return e(r, void 0, void 0, (function() {
                        var e, r;
                        return n(this, (function(n) {
                            switch (n.label) {
        ...
        var n = this.nE();
        return this.zT = new Qi(Te.nt(), n, this.JT, this.KT), this.zT.start(t, e);
    }, t.HT = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new I(T.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return this.GT(), new so(new kt(k.G, t), this, 
        /* converter= */ null);
    ...
    return t.prototype.get = function(t) {
        ...
        return this.cE.V_([ n.Pc ]).then((function(t) {
            ...
            var r = t[0];
            if (r instanceof St) return new io(e.uE, n.Pc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Vc);
            if (r instanceof xt) return new io(e.uE, n.Pc, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Vc);
            throw xe();
        }));
        ...
        return "string" == typeof e || e instanceof Mr ? (mr("Transaction.update", arguments, 3), 
        r = lo("Transaction.update", t, this.uE), i = this.uE.tE.kc("Transaction.update", e, n, o)) : (vr("Transaction.update", arguments, 2), 
        r = lo("Transaction.update", t, this.uE), i = this.uE.tE.$c("Transaction.update", e)), 
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.dE(), "string" == typeof e || e instanceof Mr ? (mr("WriteBatch.update", arguments, 3), 
        r = lo("WriteBatch.update", t, this.uE), i = this.uE.tE.kc("WriteBatch.update", e, n, o)) : (vr("WriteBatch.update", arguments, 2), 
        r = lo("WriteBatch.update", t, this.uE), i = this.uE.tE.$c("WriteBatch.update", e)), 
    ...
    return t(n, e), n.oE = function(t, e, r) {
        ...
        get: function() {
            return new ao(this.Pc.path.M(), this.firestore, this.Vc);
        },
        enumerable: !0,
        configurable: !0
        ...
        return "string" == typeof t || t instanceof Mr ? (mr("DocumentReference.update", arguments, 2), 
        n = this.firestore.tE.kc("DocumentReference.update", t, e, r)) : (vr("DocumentReference.update", arguments, 1), 
        n = this.firestore.tE.$c("DocumentReference.update", t)), this.zT.write(n.gc(this.Pc, yt.exists(!0)));
        ...
        "object" != typeof t[i] || Ji(t[i]) || (Sr("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        ...
        var i = new Yi({
            ...
            error: r
        }), o = this.zT.listen(kt.Wt(this.Pc.path), i, t);
        return function() {
            i.kT(), n.zT.al(o);
        };
        ...
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.GT().FT(e.Pc).then((function(t) {
                ...
                /*fromCache=*/ !0, t instanceof xt && t.At, e.Vc));
            }), r) : e.TE(n, r, t);
        }));
    ...
    return t.prototype.data = function(t) {
        ...
        this.EE) {
            ...
            return new Hi(this.uE.mc, this.uE.aE(), t.serverTimestamps || "none", (function(t) {
        ...
        this.EE) {
            ...
            if (null !== r) return new Hi(this.uE.mc, this.uE.aE(), e.serverTimestamps || "none", (function(t) {
...
}(io), so = /** @class */ function() {
    function t(t, e, n) {
        this.RE = t, this.firestore = e, this.Vc = n;
    }
    return t.prototype.where = function(e, n, r) {
        vr("Query.where", arguments, 3), xr("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i, o = Nr("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, n), s = si("Query.where", e);
        if (s.Y()) {
        ...
        } else "in" /* IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || this.AE(r, o), 
        i = this.firestore.tE.Mc("Query.where", r, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === o);
        var f = Vt.create(s, o, i);
        return this.PE(f), new t(this.RE.Gt(f), this.firestore, this.Vc);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (gr("Query.orderBy", arguments, 1, 2), Er("Query.orderBy", "non-empty string", 2, n), 
        ...
        var i = si("Query.orderBy", e), o = new jt(i, r);
        return this.VE(o), new t(this.RE.zt(o), this.firestore, this.Vc);
    }, t.prototype.limit = function(e) {
        return vr("Query.limit", arguments, 1), wr("Query.limit", "number", 1, e), Pr("Query.limit", 1, e), 
        new t(this.RE.Ht(e), this.firestore, this.Vc);
    }, t.prototype.limitToLast = function(e) {
        return vr("Query.limitToLast", arguments, 1), wr("Query.limitToLast", "number", 1, e), 
        Pr("Query.limitToLast", 1, e), new t(this.RE.Yt(e), this.firestore, this.Vc);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        mr("Query.startAt", arguments, 1);
        var i = this.gE("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(this.RE.Jt(i), this.firestore, this.Vc);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        mr("Query.startAfter", arguments, 1);
        var i = this.gE("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t(this.RE.Jt(i), this.firestore, this.Vc);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        mr("Query.endBefore", arguments, 1);
        var i = this.gE("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(this.RE.Xt(i), this.firestore, this.Vc);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        mr("Query.endAt", arguments, 1);
        var i = this.gE("Query.endAt", e, n, 
        /*before=*/ !1);
        return new t(this.RE.Xt(i), this.firestore, this.Vc);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Rr("isEqual", "Query", 1, e);
        return this.firestore === e.firestore && this.RE.isEqual(e.RE) && this.Vc === e.Vc;
    }, t.prototype.withConverter = function(e) {
        return new t(this.RE, this.firestore, e);
    }, 
    /** Helper function to create a bound from a document or fields */ t.prototype.gE = function(t, e, n, r) {
        if (xr(t, 1, e), e instanceof io) {
    ...
    t.prototype.pE = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.RE.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(et(this.firestore.mc, t.key)); else {
    ...
    t.prototype.yE = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                var u = this.RE.path.child(k.K(s));
                ...
                var a = new L(u);
                i.push(et(this.firestore.mc, a));
            } else {
                var c = this.firestore.tE.Mc(t, s);
                i.push(c);
            }
        }
        return new qt(i, n);
        ...
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || Ji(t[i]) || (Sr("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        ...
        if (t.ae() && 0 === t.Ot.length) throw new I(T.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        return gr("Query.get", arguments, 0, 1), fo("Query.get", t), this.bE(this.RE), new Promise((function(n, r) {
    ...
    t.prototype.mE = function(t) {
        if ("string" == typeof t) {
            ...
            var e = this.RE.path.child(k.K(t));
            ...
            return et(this.firestore.mc, new L(e));
        }
        if (t instanceof no) {
            var n = t;
            return et(this.firestore.mc, n.Pc);
        }
    ...
    function t(t, e, n, r) {
        this.uE = t, this.SE = e, this.DE = n, this.Vc = r, this.CE = null, this.FE = null, 
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        this.DE.docs.forEach((function(r) {
            t.call(e, n.NE(r));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new so(this.SE, this.uE, this.Vc);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (Sr("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Tr("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.DE.hs) throw new I(T.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        return this.CE && this.FE === e || (this.CE = 
        /**
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.uE === e.uE && this.SE.isEqual(e.SE) && this.DE.isEqual(e.DE) && this.Vc === e.Vc;
    }, t.prototype.NE = function(t) {
        return new oo(this.uE, t.key, t, this.metadata.fromCache, this.DE.ns.has(t.key), this.Vc);
    }, t;
}(), ao = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, kt.Wt(t), n, r) || this).$E = t, t.length % 2 != 1) throw new I(T.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = Pe.cn()), wr("CollectionReference.doc", "non-empty string", 1, t);
        var e = k.K(t);
        ...
        return new n(this.$E, this.firestore, t);
    }, n;
}(so);
...
function co(t, e) {
    ...
    if (Sr(t, e, [ "merge", "mergeFields" ]), Tr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
        ...
        return "string" == typeof t || t instanceof Mr;
...
function ho(t, e) {
    return void 0 === e ? {} : (Sr(t, e, [ "serverTimestamps" ]), Ir(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function fo(t, e) {
    Er(t, "object", 1, e), e && (Sr(t, e, [ "source" ]), Ir(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var mo = vo($i, "Use firebase.firestore() instead."), go = vo(to, "Use firebase.firestore().runTransaction() instead."), wo = vo(eo, "Use firebase.firestore().batch() instead."), Eo = vo(no, "Use firebase.firestore().doc() instead."), bo = vo(io), To = vo(oo), Io = vo(so), No = vo(uo), _o = vo(ao, "Use firebase.firestore().collection() instead."), Ao = vo(Kr, "Use FieldValue.<field>() instead."), Do = vo(Ur, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), xo = {
    Firestore: mo,
    GeoPoint: Yr,
    Timestamp: S,
    Blob: Do,
    ...
    return t.prototype.Q_ = function(t) {
        ...
        for (var t = 0, e = this.OE; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
    }, t.prototype.LE = function() {
     ...
     */    return t.prototype.YE = function(t, e) {
        ...
        var n = [ this.HE, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = g(), o = {
        ...
        this.YE(o.initMessageHeaders, e), 
        ...
        var d = i.createWebChannel(u, o), y = !1, v = !1, m = new Po({
            qE: function(t) {
        ...
        return b(w.EventType.OPEN, (function() {
            ...
            v || (v = !0, _e("Connection", "WebChannel transport closed"), m.GE());
            ...
            }("Connection", "WebChannel transport errored:", t), m.GE(new I(T.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!v) {
                ...
                if (i) {
                    ...
                    v = !0, m.GE(new I(s, u)), d.close();
                } else _e("Connection", "WebChannel received:", n), m.zE(n);
            }
        })), setTimeout((function() {
